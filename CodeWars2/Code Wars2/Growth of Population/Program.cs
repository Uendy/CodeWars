...
public class Program
{
    ...
    {
        //Check Kata here: https://www.codewars.com/kata/growth-of-a-population/train/csharp
        ...
        double percentGrowth = double.Parse(Console.ReadLine());
        percentGrowth /= 100;

        int newInhabitants = int.Parse(Console.ReadLine());
        int desiredPopulation = int.Parse(Console.ReadLine());

        int yearsPassed = 0;
        while (populationStart < desiredPopulation)
        {
            populationStart = populationStart + (int)(populationStart * percentGrowth) + newInhabitants;
